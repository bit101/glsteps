...
const (
	width                = 400
	height               = 400
	vertexShaderSource   = "step08/vertex_shader.gl"
	fragmentShaderSource = "step08/fragment_shader.gl"
	verticesSource       = "step08/vertices.json"
)
...
// Main - here the vertex shader creates the color and passes it to the fragment shader.
// Look in those two files. No changes in this file.
func Main() {
	runtime.LockOSThread()
	initGlfw()
	window := createWindow("Step 08")
